...
func (au *ArticleUpdate) SetContent(sc *schema.ArticleContent) *ArticleUpdate {
	au.mutation.SetContent(sc)
	return au
}
...
// SetContent sets the "content" field.
func (auo *ArticleUpdateOne) SetContent(sc *schema.ArticleContent) *ArticleUpdateOne {
	auo.mutation.SetContent(sc)
	return auo
}
